    ...
    wayland.windowManager.hyprland = {
        ...
        settings =  {
            ...
            bind = [
                ...
                "$mainMod SHIFT, 1, movetoworkspace, 1, follow"
                "$mainMod SHIFT, 2, movetoworkspace, 2, follow"
                "$mainMod SHIFT, 3, movetoworkspace, 3, follow"
                "$mainMod SHIFT, 4, movetoworkspace, 4, follow"
                "$mainMod SHIFT, 5, movetoworkspace, 5, follow"
                "$mainMod SHIFT, 6, movetoworkspace, 6, follow"
                "$mainMod SHIFT, 7, movetoworkspace, 7, follow"
                "$mainMod SHIFT, 8, movetoworkspace, 8, follow"
                "$mainMod SHIFT, 9, movetoworkspace, 9, follow"
                "$mainMod SHIFT, 0, movetoworkspace, 10,follow"
